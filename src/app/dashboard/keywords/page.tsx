    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <button
          ...
          className={`bg-card border rounded-xl p-4 text-left transition ${
            filter === "winner" ? "border-success" : "border-border hover:border-success"
          }`}
        >
        ...
        <button
          ...
          className={`bg-card border rounded-xl p-4 text-left transition ${
            filter === "loser" ? "border-danger" : "border-border hover:border-danger"
          }`}
        >
          <div className="flex items-center gap-2 mb-1">
        ...
        <button
          ...
          className={`bg-card border rounded-xl p-4 text-left transition ${
            filter === "testing" ? "border-warning" : "border-border hover:border-warning"
          }`}
        >
          <div className="flex items-center gap-2 mb-1">
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className={`border border-border rounded-lg px-4 py-2.5 text-sm flex items-center gap-2 transition ${
            filter === "all" ? "bg-primary text-white border-primary" : "hover:border-primary"
          }`}
        >
