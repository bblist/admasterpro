...
const keywords: Keyword[] = [
    ...
    {
        id: 3,
        keyword: "sushi restaurant near me",
    ...
    {
        id: 7,
        keyword: "how to unclog drain yourself",
        campaign: "Emergency Plumbing",
        spent: 15.0,
        clicks: 11,
        calls: 0,
    ...
    {
        id: 9,
        keyword: "eye doctor accepting new patients",
        campaign: "LASIK & Eye Exams",
        spent: 28.0,
        clicks: 12,
        calls: 3,
    ...
    {
        id: 10,
        keyword: "auto detailing near me",
    ...
    {
        id: 11,
        keyword: "designer handbags on sale",
        ...
        <div className="max-w-6xl mx-auto space-y-6">
            <div>
                <h1 className="text-2xl font-bold flex items-center gap-2">
                    Keywords
                    <Tooltip text="Keywords are the search terms that trigger your ads. Winners bring real customers, losers waste money. The AI monitors these 24/7." />
                </h1>
