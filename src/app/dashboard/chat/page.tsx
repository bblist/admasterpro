            ...
            <div className="flex-1 overflow-auto space-y-4 pb-4">
                {messages.map((msg) => (
                    ...
                    >
                        {/* Avatar */}
                        <div
                            className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${msg.role === "ai" ? "bg-primary" : "bg-muted/20"
                                }`}
                        >
                            {msg.role === "ai" ? (
                        ...
                        >
                            <div
                                className={`rounded-xl px-4 py-3 text-sm leading-relaxed ${msg.role === "ai"
                                ...
                                <div className="flex flex-wrap gap-2 mt-2">
                                    {msg.actions.map((action, i) => (
                                        <button
                                            ...
                                            className={`text-xs px-3 py-1.5 rounded-lg transition ${action.type === "primary"
