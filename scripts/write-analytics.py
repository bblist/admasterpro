#!/usr/bin/env python3
"""Write the analytics dashboard page with Recharts charts."""
                                ...
                                <AreaChart data={chartData}>
                                    ...
                                    <Tooltip
                                        ...
                                        formatter={(value: number) => [
                                            `${chart.prefix}${typeof value === "number" ? value.toFixed(2) : value}`,
                                            chart.label
                                        ]}
                                    />
...
with open('/Users/bblist/admasterpro/src/app/dashboard/analytics/page.tsx', 'w') as f:
    f.write(content)

print("Analytics page written successfully")
